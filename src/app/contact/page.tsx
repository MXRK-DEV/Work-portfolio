         ...
         <div>
          ...
          className="h-1/2 lg:h-full lg:w-1/2 bg-red-50 rounded-xl text-xl flex flex-col gap-8 justify-center p-24">
            ...
            <button className="bg-purple-200 rounded font-semibold text-gray-600 p-4">Send</button>
             { success && <span className="text-green-300 font-semibold">Your message has been sent successfully!</span>}
             {error && <span className="text-red-300 font-semibold">Something went wrong!</span>}
          </form>
       </div> 
      </motion.div>
  )
